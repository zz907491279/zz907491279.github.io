...
function zylb(Imgbox,lbImg,lbd,leftbtn,rightbtn) {
    var box = document.querySelector(Imgbox);
    var imgs = document.querySelectorAll(lbImg);
    var lis = document.querySelectorAll(lbd);
    var pre = document.querySelector(leftbtn);
